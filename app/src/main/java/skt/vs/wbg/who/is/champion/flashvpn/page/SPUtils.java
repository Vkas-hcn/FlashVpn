...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = BaseAppFlash.Companion.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = BaseAppFlash.Companion.getInstance().getSharedPreferences(spName, mode);
    }
